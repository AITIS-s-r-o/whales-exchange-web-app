const dict = {
    en: {
        ...
        pay_invoice_intro_notice:
            "Note: These are HODL invoices. When you pay either invoice, it will not be completed immediately. It will appear as \"pending\", \"queued\", or \"on-hold\" in your wallet. This is OK, you need to pay both to proceed.",
        pay_invoice_to:
