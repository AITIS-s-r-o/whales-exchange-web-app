const dict = {
    en: {
        ...
        wex_provider_limit_forward: "Forward Swap",
        wex_provider_limit_forward_sub: "(BTC → LN) Limits",
        wex_provider_limit_reverse: "Reverse Swap",
        wex_provider_limit_reverse_sub: "(LN → BTC) Limits",
        wex_provider_fee: "Provider Fee",
        wex_provider_none: "No provider selected.",
        wex_provider_table_pubkey: "Pubkey",
        wex_provider_table_fee: "Fee",
        wex_provider_table_max_forward: "Max Forward", 
        wex_provider_table_max_reverse: "Max Reverse", 
        wex_provider_table_last_seen: "Last Seen", 
        wex_provider_table_seen_min_ago: "min ago",
        wex_provider_table_seen_mins_ago: "mins ago",
        wex_provider_table_seen_hour_ago: "hour ago",
        wex_provider_table_seen_hours_ago: "hours ago",
        wex_provider_table_seen_day_ago: "day ago",
        ...
        pay_invoice_to_description: "This small fee invoice is not trustless and covers Bitcoin mining fees that the swap provider would have to pay in case the client is non-cooperative (or malicious). Note that if the selected swap provider is malicious, the client can lose this payment.",
        pay_fee_invoice_to_description: "The large swap invoice is trustless and in case the swap provider is non-cooperative or malicious, the client is protected and can get the money back.",
